...
const search= numbers.find((number)=>number === 100);
console.log(search);
...
const search2= movies.find((movie)=>movie.date === 2010);
console.log(search2);
...
const obj1=aliens.find((alien)=>alien.name === 'Cucushumushu');
console.log(obj1);
const obj2=mutations.find((mutation)=>mutation.name ==='Porompompero' )
console.log(obj2);
