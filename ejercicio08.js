...
const game=videogames.find((videogame)=> videogame.genders.length>0
);
console.log(game);
const mediaGame=videogames.reduce((acc,videogame)=>acc+videogame.score,0)
 / videogames.length
console.log(mediaGame);